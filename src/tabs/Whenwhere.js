  ...
  render(){
    return(
      <div className="tab">
        ...
        <h2>Vigsel</h2>
        <p>
        Klockan 14 börjar vigseln i slottskapellet i Kežmarok.<br/>
        ...
        <h2>Fest!</h2>
        <p>
        Efter vigsel kommer det bli fest i en lokal som ligger på gångavstånd
        till kapellet. Festen kommer fortsätta till morgondagen! Yeeey :D <br/>
